...
class DataFixing():
    ...
    def __init__(self):
        self.version = 1.0
        self.kentucky_station_csv = "BMBL_Barbourville-3-E_Knox" # Do not put ".csv" to end. It will be added later on in the script
        ...
        self.st02_file_loc_0 = "/home/kaleb/Files/FixingData/SOILDATA/ST02/"
        self.sm02_file_loc_0 = "/home/kaleb/Files/FixingData/SOILDATA/SM02/"

        # Point at the exact file of the pressure data. Script thinks its formatted as 3 years worth of data. 
    ...
    def add_column(self, param, param_df, kentucky_df):
        ...
        print("\nLength of each df:\nKentucky: ", len(kentucky_df), "\tParameter: ", len(param_df), "\n")
...
def main(self):
    ...
    for i in range(0, year_range + 1):
        ...
        kentucky_df = f.expand_df(kentucky_df)
        ...
        if not os.path.exists(newPath):
            os.makedirs(newPath)
        kentucky_df.to_csv(newPath + 'New_' + f.kentucky_station_csv, index=False)
